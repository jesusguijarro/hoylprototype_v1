...
+[Estoy cansado de cuando en cuando]
    ~ q17 = 0
    ¡Está bien, algunas veces nos encontramos cansados! #Portrait:fairy_neutral
+[Estoy cansado muchos días]
    ~ q17 = 1
    ¡Oh, eso debe ser duro! #portrait:fairy_sad
...
+[Me siento solo muchas veces]
    ~ q20 = 1
    ¡Oh, eso me entristece! #portrait:fairy_sad
...
+[Como muy bien]
    ~ q18 = 0
    ¡Oh, eso me alegra! #portrait:fairy_happy
...
+[No puedo decidirme]
    ~ q13 = 2
    ¡Que difícil cuando no podemos decidir! #portrait:fairy_sad
+[Me cuesta decidirme]
    ~ q13 = 1
    ¡Eso suele pasarme también! #portrait:fairy_sad
+[Me decido fácilmente]
    ~ q13 = 0
    ¡Me alegra escuchar eso! #portrait:fairy_happy

- ¡A mí me cuesta mucho decidirme! #portrait:fairy_sad
...
+[Muchas noches me cuesta dormirme]
    ~ q16 = 1
   ¡ Eso suele paasarme también! #portrait:fairy_sad
+[Duermo muy bien]
    ~ q16 = 0
    ¡Me alegra escuchar eso! #portrait:fairy_happy
