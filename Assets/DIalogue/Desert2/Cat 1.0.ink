INCLUDE ../globals.ink
    ...
    ¡Saludos, ~PlayerUsername! Bienvenido al Desierto de los Antiguos. Mi nombre es Gato, y necesito tu ayuda. #speaker:Gato #portrait:bastet_neutral #layout:right
...
- ¿Tú qué piensas sobre las cosas malas que pasan a tú al rededor ~PlayerUsername? #speaker:Gato #portrait:bastet_neutral #layout:right //8
...
- ¡Listo, basta de charla puedes encontrar al faraón entrando a la pirámide de la isla de la izquierda, mucha suerte! #portrait:bastet_happy
