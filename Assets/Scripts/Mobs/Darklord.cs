...
public class Darklord : Interactable, IEnemy
{
    ...
    private IEnumerator ShowGuide()
    {
        ...
        GuideUIManager.Instance.Parameters("Enemigo derrotado!","Has derrotado al Señor Oscuro, dirigite al rededor del puente del Norte encontrarás a alguien...!",image);
    }
